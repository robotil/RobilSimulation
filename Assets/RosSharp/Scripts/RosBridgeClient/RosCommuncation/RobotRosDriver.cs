...
{
    public class RobotRosDriver : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (!RobotDriver.manualInput)
            {
                RobotDriver.Apply((float)Float64SubThrottle.whatever, (float)Float64SubSteering.whatever);
            }
